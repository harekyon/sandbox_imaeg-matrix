...
export default function Home() {
  useEffect(() => {
    ...
    controls[0].style.left = 25 + "px";
    controls[0].style.top = 25 + "px";

    controls[1].style.left = 180 + "px";
    controls[1].style.top = 25 + "px";

    controls[2].style.left = 180 + "px";
    controls[2].style.top = 180 + "px";

    controls[3].style.left = 25 + "px";
    controls[3].style.top = 180 + "px";
